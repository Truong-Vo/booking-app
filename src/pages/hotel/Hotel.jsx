      ...
      <div className="hotelContainer">
        {open && (
          <div className="slider">
            ...
            <FontAwesomeIcon icon={faCircleArrowLeft} className="arrow" onClick={() => handleMove(sliderNumber)} />
            <div className="sliderWrapper">
              <img src={photos[sliderNumber].src} alt="" className="sliderImg" />
            </div>
            <FontAwesomeIcon icon={faCircleArrowRight} className="arrow" onClick={() => handleMove(sliderNumber)} />
          </div>
        )}
